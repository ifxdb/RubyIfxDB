...
*/
typedef struct _ifx_db_connect_args_struct {
#ifdef UNICODE_SUPPORT_VERSION
  SQLWCHAR          *database;
  SQLWCHAR          *uid;
  SQLWCHAR          *password;
...
*/
typedef struct _ifx_db_end_tran_args_struct {
  SQLHANDLE      *hdbc;
...
*/
typedef struct _ifx_db_describeparam_args_struct {
...
*/
typedef struct _ifx_db_describecol_args_struct {
  stmt_handle   *stmt_res;
  SQLUSMALLINT  col_no;
...
*/
typedef struct _ifx_db_metadata_args_struct {
  stmt_handle   *stmt_res;
#ifdef UNICODE_SUPPORT_VERSION
  SQLWCHAR      *qualifier;
  SQLWCHAR      *owner;
...
*/
typedef struct _ifx_db_exec_direct_args_struct {
  stmt_handle   *stmt_res;
#ifdef UNICODE_SUPPORT_VERSION
...
*/
typedef struct _ifx_db_create_drop_db_args_struct {
...
*/
typedef struct _ifx_db_param_and_put_data_struct {
  stmt_handle   *stmt_res;
  SQLPOINTER    valuePtr;
...
*/
typedef struct _ifx_db_next_result_args_struct {
  SQLHSTMT      *new_hstmt;
  stmt_handle   *stmt_res;
  int 			rc;
} next_result_args;
...
*/
typedef struct _ifx_db_row_col_count_struct {
  stmt_handle    *stmt_res;
  SQLSMALLINT    count;
  int 			 rc;
} row_col_count_args;
...
*/
typedef struct _ifx_db_row_count_struct {
  stmt_handle    *stmt_res;
  SQLINTEGER     count;
  int 			 rc;
} sql_row_count_args;
...
*/
typedef struct _ifx_db_col_attr_struct {
  stmt_handle    *stmt_res;
  SQLSMALLINT    col_num;
...
*/
typedef struct _ifx_db_bind_col_struct {
  stmt_handle    *stmt_res;
...
*/
typedef struct _ifx_db_get_data_args_struct {
  stmt_handle    *stmt_res;
  SQLSMALLINT    col_num;
  SQLSMALLINT    targetType;
  SQLPOINTER     buff;
...
*/
typedef struct _ifx_db_get_data_length_struct {
  SQLHSTMT       *new_hstmt;
  SQLSMALLINT    col_num;
  stmt_handle    *stmt_res;
  SQLINTEGER     *sLength;
...
*/
typedef struct _ifx_db_get_data_subString_struct {
  SQLHSTMT       *new_hstmt;
  SQLSMALLINT    col_num;
  stmt_handle    *stmt_res;
...
*/
typedef struct _ifx_db_fetch_data_struct {
  stmt_handle    *stmt_res;
...
*/
typedef struct _ifx_db_set_handle_attr_struct {
  SQLHANDLE    *handle;
...
*/
typedef struct _ifx_db_get_handle_attr_struct {
  SQLHANDLE    *handle;
  SQLINTEGER   attribute;
  SQLPOINTER   valuePtr;
...
*/
typedef struct _ifx_db_bind_parameter_struct {
  stmt_handle    *stmt_res;
...
*/
typedef struct _ifx_db_get_info_struct {
  conn_handle   *conn_res;
...
*/
typedef struct _ifx_db_get_diagRec_struct {
  SQLSMALLINT       hType;
  SQLHANDLE         handle;
  SQLSMALLINT       recNum;
  SQLPOINTER        SQLState;
...
*/
typedef struct _ifx_db_free_stmt_struct {
  stmt_handle   *stmt_res;
  SQLUSMALLINT  option;
  int			rc;
} free_stmt_args;

int _ruby_ifx_db_SQLConnect_helper(connect_args *data);
int _ruby_ifx_db_SQLDisconnect_helper(SQLHANDLE *hdbc);
void _ruby_ifx_db_Connection_level_UBF(void *data);
int _ruby_ifx_db_SQLEndTran(end_tran_args *endtran_args);
int _ruby_ifx_db_SQLDescribeParam_helper(describeparam_args *data);
int _ruby_ifx_db_SQLDescribeCol_helper(describecol_args *data);
int _ruby_ifx_db_SQLBindCol_helper(bind_col_args *data);
int _ruby_ifx_db_SQLColumnPrivileges_helper(metadata_args *data);
int _ruby_ifx_db_SQLColumns_helper(metadata_args *data);
int _ruby_ifx_db_SQLPrimaryKeys_helper(metadata_args *data);
int _ruby_ifx_db_SQLForeignKeys_helper(metadata_args *data);
int _ruby_ifx_db_SQLProcedureColumns_helper(metadata_args *data);
int _ruby_ifx_db_SQLProcedures_helper(metadata_args *data);
int _ruby_ifx_db_SQLSpecialColumns_helper(metadata_args *data);
int _ruby_ifx_db_SQLStatistics_helper(metadata_args *data);
int _ruby_ifx_db_SQLTablePrivileges_helper(metadata_args *data);
int _ruby_ifx_db_SQLTables_helper(metadata_args *data);
int _ruby_ifx_db_SQLExecDirect_helper(exec_cum_prepare_args *data);
int _ruby_ifx_db_SQLPrepare_helper(exec_cum_prepare_args *data);
int _ruby_ifx_db_SQLFreeStmt_helper(free_stmt_args *data);
int _ruby_ifx_db_SQLExecute_helper(stmt_handle *stmt_res);
int _ruby_ifx_db_SQLParamData_helper(param_cum_put_data_args *data);
int _ruby_ifx_db_SQLColAttributes_helper(col_attr_args *data);
int _ruby_ifx_db_SQLPutData_helper(param_cum_put_data_args *data);
int _ruby_ifx_db_SQLGetData_helper(get_data_args *data);
int _ruby_ifx_db_SQLGetLength_helper(get_length_args *data);
int _ruby_ifx_db_SQLGetSubString_helper(get_subString_args *data);
int _ruby_ifx_db_SQLNextResult_helper(next_result_args *data);
int _ruby_ifx_db_SQLFetchScroll_helper(fetch_data_args *data);
int _ruby_ifx_db_SQLFetch_helper(fetch_data_args *data);
int _ruby_ifx_db_SQLNumResultCols_helper(row_col_count_args *data);
int _ruby_ifx_db_SQLNumParams_helper(row_col_count_args *data);
int _ruby_ifx_db_SQLRowCount_helper(sql_row_count_args *data);
int _ruby_ifx_db_SQLGetInfo_helper(get_info_args *data);
int _ruby_ifx_db_SQLGetDiagRec_helper(get_diagRec_args *data);
int _ruby_ifx_db_SQLSetStmtAttr_helper(set_handle_attr_args *data);
int _ruby_ifx_db_SQLSetConnectAttr_helper(set_handle_attr_args *data);
int _ruby_ifx_db_SQLSetEnvAttr_helper(set_handle_attr_args *data);
int _ruby_ifx_db_SQLGetStmtAttr_helper(get_handle_attr_args *data);
int _ruby_ifx_db_SQLGetConnectAttr_helper(get_handle_attr_args *data);
int _ruby_ifx_db_SQLBindFileToParam_helper(stmt_handle *stmt_res, param_node *curr);
int _ruby_ifx_db_SQLBindParameter_helper(bind_parameter_args *data);
void _ruby_ifx_db_Statement_level_UBF(stmt_handle *stmt_res);
int _ruby_ifx_db_SQLCreateDB_helper(create_drop_db_args *data);
int _ruby_ifx_db_SQLDropDB_helper(create_drop_db_args *data);
